package org.deblock.domain.usecase
...
class FlightSearchUseCaseImplTest {
    ...
    @Test
    fun `should aggregate and sort flights from all suppliers`() = runBlocking {
        // Given
        val request = FlightSearchCriteria(
            origin = "LHR",
            destination = "AMS",
        ...
        coEvery { supplier1.name } returns "Supplier1"
        coEvery { supplier2.name } returns "Supplier2"
